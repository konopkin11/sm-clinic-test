...
INSERT INTO public.booking
    (id, room_id, end_time, start_time)
VALUES (3,  252, '2023-09-15 10:30:00.000', '2023-09-15 09:30:00.000') ON CONFLICT (id) DO NOTHING;
select nextval('booking_seq');
INSERT INTO public.booking
    (id, room_id, end_time, start_time)
VALUES (4, 252, '2023-09-15 11:30:00.000', '2023-09-15 10:30:00.000') ON CONFLICT (id) DO NOTHING;
select nextval('booking_seq');
INSERT INTO public.booking
    (id, room_id, end_time, start_time)
VALUES (5, 252, '2023-09-15 12:30:00.000', '2023-09-15 12:30:00.000') ON CONFLICT (id) DO NOTHING;
select nextval('booking_seq');